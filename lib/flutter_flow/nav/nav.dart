...
class AppStateNotifier extends ChangeNotifier {
  PickPackForiOSFirebaseUser? initialUser;
  PickPackForiOSFirebaseUser? user;
  ...
  void update(PickPackForiOSFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'OrderPackPage',
              path: 'orderPackPage',
              builder: (context, params) => OrderPackPageWidget(),
            ),
            FFRoute(
              name: 'PackListPage',
              path: 'packListPage',
              builder: (context, params) => PackListPageWidget(
